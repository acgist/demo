package com.acgist.ml.SingleLayerNeuralNetworks;

import static com.acgist.ml.util.ActivationFunction.step;

import java.util.Random;

import com.acgist.ml.util.GaussianDistribution;
...
public class Perceptrons {
	...
	public static void main(String[] args) {
		...
		//
		// Let training data set for each class follow Normal (Gaussian) distribution
		// here:
