...
public class APITest {
	...
	public void mapToBean() {
		...
		Map<String, String> data = api.toMap();
		System.out.println(data);
		data.put("test", "test");
		data.put("queryId", "queryId");
		Gateway request = new PayRequest();
		System.out.println(data);
...
//				""
		...
		service.init();
		GatewayRequest api = new GatewayRequest();
		api.setRequestTime("1234");
		api.signature();
		System.out.println(api);
		System.out.println(SignatureService.verify(api));
	}
	
	@Test
	public void toStringTest() {
		Gateway api = new GatewayRequest();
		api.setSign("sign");
		System.out.println(api);
	}
