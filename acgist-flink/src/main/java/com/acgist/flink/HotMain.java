...
public class HotMain {
	...
	public static void main(String[] args) throws Exception {
		...
		String[] fields = new String[] { "userId", "itemId", "categoryId", "behavior", "timestamp" };
		PojoCsvInputFormat<UserBehavior> csvInput = new PojoCsvInputFormat<>(filePath, pojoTypeInfo, fields);
		...
		DataStream<UserBehavior> pvData = timedData.filter((userBehavior) -> {
			return userBehavior.behavior.equals("pv"); // 过滤出只有点击的数据
		});
...
//			Long itemId = ((Tuple1<Long>) key).f0;
	...
	public static class ItemViewCount {
		...
		public static final ItemViewCount of(long itemId, long windowEnd, long viewCount) {
