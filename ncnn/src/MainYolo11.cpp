...
static int detect_yolo11(const cv::Mat& bgr, std::vector<Object>& objects)
{
    ...
    // yolo11.opt.use_fp16_storage = true;

    // https://github.com/nihui/ncnn-android-yolo11/tree/master/app/src/main/assets
    // yolo11.load_param("ncnn.param");
    // yolo11.load_model("ncnn.bin");
    // yolo11.load_param("ncnn.fp16.param");
    // yolo11.load_model("ncnn.fp16.bin");
    // yolo11.load_param("model.ncnn.param");
    // yolo11.load_model("model.ncnn.bin");
    // yolo11.load_param("model.ncnn.fp16.param");
    // yolo11.load_model("model.ncnn.fp16.bin");
    // yolo11.load_param("yolo11n.ncnn.param");
    // yolo11.load_model("yolo11n.ncnn.bin");
    yolo11.load_param("yolo11n.ncnn.fp16.param");
    yolo11.load_model("yolo11n.ncnn.fp16.bin");
    for(auto& v : yolo11.input_names()) {
        std::cout << v << std::endl;
    }
    for(auto& v : yolo11.output_names()) {
        std::cout << v << std::endl;
    }
