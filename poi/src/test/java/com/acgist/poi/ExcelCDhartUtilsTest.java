...
public class ExcelCDhartUtilsTest {
	...
	public void testChart() throws IOException {
		...
		final LineChart singleLineChart = new LineChart("张三", 0, 5, 20);
		...
		final LineChart scoreChart = new LineChart("张三", 1, 5, 20);
		...
		final LineChart salesChart = new LineChart("价格", 2, 5, 20);
