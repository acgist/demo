...
public class RedirectUtils {
	 ...
	 * 跳转错误提示页面
	 */
	public static final void error(ResponseCode code, HttpServletRequest request, HttpServletResponse response) {
	 ...
	 * 跳转错误提示页面
	 */
	public static final void error(ResponseCode code, String message, HttpServletRequest request, HttpServletResponse response) {
