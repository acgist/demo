package com.acgist.modules.sign;
...
public class SignService {
	...
	public SignService(String publicKeyValue, String privateKeyValue) {
	 ...
	 * 验签
	 */
	public static final boolean verify(API api) {
		if (api == null) {
			return false;
		}
	 ...
	 * 签名
	 */
	public static final void sign(API api) {
		if (api == null) {
			return;
		}
		final String digest = dataToDigest(api.data());
